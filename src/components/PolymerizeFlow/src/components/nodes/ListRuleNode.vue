...
<!--      <p>列表规则节点</p>-->
  ...
  <ListRuleNodeModal @register="registerModal" @success="handleSuccess"></ListRuleNodeModal>
</template>
...
import ListRuleNodeModal from "./ListRuleNodeModal.vue";
