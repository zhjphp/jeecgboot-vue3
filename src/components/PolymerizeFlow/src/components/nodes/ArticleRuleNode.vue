...
<!--      <p>稿件采集节点</p>-->
  ...
  <ArticleRuleNodeModal @register="registerModal" @success="handleSuccess"></ArticleRuleNodeModal>
</template>
...
import ArticleRuleNodeModal from "./ArticleRuleNodeModal.vue";
