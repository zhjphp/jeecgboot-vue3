...
<template>
  <div>
    ...
    <InformationSourceSelectByCategoryModal :rowKey="rowKey" @register="regModal" @getSelectResult="setValue" v-bind="getBindValue"></InformationSourceSelectByCategoryModal>
  </div>
</template>
<script lang="ts">
  import { unref } from 'vue';
  import InformationSourceSelectByCategoryModal from './modal/InformationSourceSelectByCategoryModal.vue';
  ...
  export default defineComponent({
    name: 'JSelectInformationSourceByCategory',
    components: {
      InformationSourceSelectByCategoryModal,
      JSelectBiz,
    },
    inheritAttrs: false,
    props: {
