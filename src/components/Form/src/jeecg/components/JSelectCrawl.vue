...
<template>
  <div>
    ...
    <CrawlSelectModal @register="regModal" @getSelectResult="setValue" v-bind="getBindValue"></CrawlSelectModal>
  </div>
</template>
<script lang="ts">
  import CrawlSelectModal from './modal/CrawlSelectModal.vue';
